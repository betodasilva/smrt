...
/* harmony import */ var ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ngx-slick-carousel */ "./node_modules/ngx-slick-carousel/fesm5/ngx-slick-carousel.js");
...
/* harmony import */ var _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @ngx-translate/http-loader */ "./node_modules/@ngx-translate/http-loader/fesm5/ngx-translate-http-loader.js");
...
var FloatContainerComponent = /** @class */ (function () {
    function FloatContainerComponent(window, renderer) {
        this.window = window;
        this.renderer = renderer;
        this.isFloatContainerFixed = false;
    }
    FloatContainerComponent.prototype.ngOnInit = function () {
        this.listenForHeaderOpen();
        console.log("elementos", this.startPosEl, this.endPosEl);
    };
    FloatContainerComponent.prototype.ngAfterViewInit = function () {
    ...
    FloatContainerComponent.prototype.onWindowScroll = function (event) {
        var currentScroll = this.window.pageYOffset;
    ...
    FloatContainerComponent.prototype.listenForHeaderOpen = function () {
        var _this = this;
        src_app_services_emitter_emitter_service__WEBPACK_IMPORTED_MODULE_3__["EmitterService"].get('headerOpen').subscribe(function (isOpen) {
            if (isOpen && _this.window.pageYOffset - 100 > _this.startPos) {
                _this.renderer.setStyle(_this.floatContainer.nativeElement, 'transform', 'translateY(100px)');
            }
            else {
                _this.renderer.removeStyle(_this.floatContainer.nativeElement, 'transform');
    ...
    FloatContainerComponent.prototype.setAbsolutePosition = function () {
        this.renderer.setStyle(this.floatContainer.nativeElement, 'transition', "none");
    ...
    FloatContainerComponent.prototype.removeAbsolutePosition = function () {
        var _this = this;
        setTimeout(function () {
            _this.renderer.removeStyle(_this.floatContainer.nativeElement, 'transition');
        }, 200);
    ...
    FloatContainerComponent.ctorParameters = function () { return [
        { type: Window, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [src_app_services_window_service__WEBPACK_IMPORTED_MODULE_2__["WINDOW"],] }] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return FloatContainerComponent;
}());
...
var ShareComponent = /** @class */ (function () {
    function ShareComponent(window) {
        this.window = window;
    }
...
var TimelineImageComponent = /** @class */ (function () {
    function TimelineImageComponent() {
    }
    TimelineImageComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var ChapterInternSimpleComponentm = /** @class */ (function () {
    function ChapterInternSimpleComponentm() {
        this.chapterHatInfo = {
    ...
    ChapterInternSimpleComponentm.prototype.ngOnInit = function () {
    };
    ...
    return ChapterInternSimpleComponentm;
}());
...
module.exports = ".chapter-content {\n  padding: 70px 0;\n  position: relative;\n  background: url('bg-arrows.svg') no-repeat center;\n  background-size: cover;\n}\n\n.timeline__line {\n  position: absolute;\n  top: 0;\n  left: 50%;\n  -webkit-transform: translateX(-50%);\n          transform: translateX(-50%);\n  width: 3px;\n  background: var(--orange);\n  bottom: 280px;\n  z-index: -1;\n}\n\n.timeline__line::before {\n  content: \"\";\n  position: absolute;\n  top: -50px;\n  left: 50%;\n  -webkit-transform: translateX(-50%);\n          transform: translateX(-50%);\n  width: 88px;\n  height: 88px;\n  border-radius: 50%;\n  background: var(--orange);\n}\n\n.timeline__item {\n  display: -webkit-box;\n  display: flex;\n  flex-wrap: wrap;\n  -webkit-box-align: top;\n          align-items: top;\n  align-content: flex-start;\n  margin-bottom: 64px;\n}\n\n@media (max-width: 991px) {\n  .timeline__item {\n    -webkit-box-pack: center !important;\n            justify-content: center !important;\n  }\n  .timeline__item:nth-of-type(odd), .timeline__item:nth-of-type(even) {\n    margin-top: 0 !important;\n  }\n  .timeline__item > app-timeline-card {\n    -webkit-box-ordinal-group: 1 !important;\n            order: 0 !important;\n    width: 100%;\n    margin: 0 auto 20px !important;\n    text-align: center !important;\n  }\n  .timeline__item > app-timeline-card ::ng-deep .timeline-card__icon {\n    margin: 0 auto !important;\n  }\n  .timeline__item > app-timeline-card::before, .timeline__item > app-timeline-card::after {\n    display: none;\n  }\n}\n\n@media (min-width: 992px) {\n  .timeline__item {\n    max-width: 870px;\n    margin-left: auto;\n    margin-right: auto;\n    flex-wrap: nowrap;\n  }\n}\n\n.timeline__item:nth-of-type(even) {\n  -webkit-box-pack: end;\n          justify-content: flex-end;\n}\n\n.timeline__item:nth-of-type(even) > app-timeline-card {\n  margin-right: 0;\n  margin-left: 30px;\n  text-align: left;\n}\n\n.timeline__item:nth-of-type(even) > app-timeline-card ::ng-deep .timeline-card__icon {\n  margin-right: auto;\n  margin-left: 0;\n}\n\n.timeline__item:last-child {\n  -webkit-box-pack: center;\n          justify-content: center;\n  margin-top: 0 !important;\n  z-index: 1;\n}\n\n.timeline__item:last-child > app-timeline-card {\n  margin-left: 0 !important;\n}\n\n.timeline__item:last-child > app-timeline-card::after, .timeline__item:last-child > app-timeline-card::before {\n  right: auto;\n  left: calc(50% - 3px) !important;\n  -webkit-transform: translateX(-50%) rotate(-45deg);\n          transform: translateX(-50%) rotate(-45deg);\n  top: 0;\n  border: 8px solid black;\n}\n\n.timeline__item:last-child > app-timeline-card::after {\n  top: 1px;\n  border-color: #fff #fff transparent transparent !important;\n}\n\n.timeline__item:last-child > app-timeline-card::before {\n  border-color: var(--orange) var(--orange) transparent transparent !important;\n}\n\n.timeline__item + .timeline__item:not(.timeline__item--img) {\n  margin-top: -140px;\n}\n\n.timeline__item:nth-of-type(even) > app-timeline-card::after, .timeline__item:nth-of-type(even) > app-timeline-card::before {\n  right: auto;\n  left: -10px;\n}\n\n.timeline__item:nth-of-type(even) > app-timeline-card::after {\n  border: 8px solid black;\n  left: -8px;\n  border-color: #fff transparent transparent #fff;\n}\n\n.timeline__item:nth-of-type(even) > app-timeline-card::before {\n  border: 8px solid black;\n  border-color: #e6e9ef transparent transparent #e6e9ef;\n}\n\n.timeline__item > app-timeline-card {\n  margin-right: 30px;\n  text-align: right;\n  position: relative;\n}\n\n.timeline__item > app-timeline-card::after, .timeline__item > app-timeline-card::before {\n  content: \"\";\n  position: absolute;\n  width: 0;\n  height: 0;\n  top: 30px;\n  right: -4px;\n  box-sizing: border-box;\n  -webkit-transform-origin: 0 0;\n          transform-origin: 0 0;\n  -webkit-transform: rotate(-45deg);\n          transform: rotate(-45deg);\n  border-radius: 2px;\n}\n\n.timeline__item > app-timeline-card::after {\n  border: 8px solid black;\n  right: -2px;\n  border-color: transparent #fff #fff transparent;\n}\n\n.timeline__item > app-timeline-card::before {\n  border: 8px solid black;\n  border-color: transparent #e6e9ef #e6e9ef transparent;\n}\n\n.timeline__item > app-timeline-card ::ng-deep .timeline-card__icon {\n  margin-left: auto;\n}\n\n@media (min-width: 992px) {\n  .timeline__item:nth-of-type(3) {\n    margin-top: -220px !important;\n  }\n  .timeline__item:nth-of-type(6) {\n    margin-top: -174px !important;\n  }\n  .timeline__item:nth-of-type(8) {\n    margin-top: -164px !important;\n  }\n  .timeline__item:nth-of-type(9) {\n    margin-top: -280px !important;\n  }\n  .timeline__item:nth-of-type(10) {\n    margin-top: -270px !important;\n  }\n  .timeline__item:nth-of-type(11) {\n    margin-top: -90px !important;\n  }\n  .timeline__item:nth-of-type(12) {\n    margin-top: -260px !important;\n  }\n}\n\n.col-left app-timeline-card,\n.col-left app-timeline-image {\n  float: right;\n}\n\n.col-right app-timeline-card,\n.col-right app-timeline-image {\n  float: left;\n}\n\n.fix-scroll {\n  position: relative;\n  top: 0;\n  -webkit-transform: translateY(0);\n          transform: translateY(0);\n  -webkit-transition: top 200ms ease, -webkit-transform 200ms ease;\n  transition: top 200ms ease, -webkit-transform 200ms ease;\n  transition: top 200ms ease, transform 200ms ease;\n  transition: top 200ms ease, transform 200ms ease, -webkit-transform 200ms ease;\n  margin: 0;\n  z-index: 0;\n}\n\n.fix-scroll.fixed {\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 20px;\n}\n\n.timeline-nav {\n  position: absolute;\n  left: 0;\n  top: 0;\n  max-width: 80px;\n}\n\n.timeline-nav__item {\n  display: block;\n  color: var(--blue-m);\n  font-size: 18px;\n  margin-bottom: 18px;\n  position: relative;\n  padding-left: 20px;\n  line-height: 1;\n  position: relative;\n  cursor: pointer;\n}\n\n.timeline-nav__item--active, .timeline-nav__item:hover {\n  color: var(--orange) !important;\n}\n\n.timeline-nav__item--active:before, .timeline-nav__item:hover:before {\n  opacity: 1 !important;\n}\n\n.timeline-nav__item:before {\n  content: \"\";\n  position: absolute;\n  left: 0;\n  top: 50%;\n  -webkit-transform: translateY(-50%);\n          transform: translateY(-50%);\n  min-width: 12px;\n  height: 12px;\n  background: url('triangle-small-orange.svg') no-repeat;\n  background-size: cover;\n  opacity: 0;\n}\n\n.timeline-nav__item:hover {\n  text-decoration: none;\n}\n\n@media (max-width: 991px) {\n  .timeline-nav {\n    display: none;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TimelineComponent = /** @class */ (function () {
    function TimelineComponent(timeline, renderer) {
    ...
    TimelineComponent.prototype.onItemNavClick = function (_a, navItem) {
        var _this = this;
        var target = _a.target;
        var elToNavigate = this.cards.find(function (el) { return el.nativeElement.getAttribute('year') === navItem; });
        if (!elToNavigate)
            return;
        elToNavigate.nativeElement.scrollIntoView({ behavior: 'smooth', block: 'center' });
        this.navItems.forEach(function (el) {
            _this.renderer.removeClass(el.nativeElement, 'timeline-nav__item--active');
        });
...
var HorizonteComponent = /** @class */ (function () {
    function HorizonteComponent() {
        this.chapterHatInfo = {
    ...
    HorizonteComponent.prototype.ngOnInit = function () {
    };
...
var ManifestoComponent = /** @class */ (function () {
    ...
    ManifestoComponent.prototype.ngOnInit = function () {
    };
...
var ListaParceirosComponent = /** @class */ (function () {
    function ListaParceirosComponent() {
        this.chapterHatInfo = {
    ...
    ListaParceirosComponent.prototype.ngOnInit = function () {
    };
    ...
    return ListaParceirosComponent;
}());
